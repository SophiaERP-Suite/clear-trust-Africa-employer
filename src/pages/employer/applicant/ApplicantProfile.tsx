        ...
        <div className="h-fit w-100 lg:w-fit">
          <div className="flex justify-start">
            <p className="font-semibold text-black py-1 text-lg">
              <Upload size={20} className="mr-2" /> Upload New Document{" "}
              {employee && `For ${employee.firstName}`}
            </p>
          </div>
          <form onSubmit={handleSubmit(uploadDocument)} noValidate>
            ...
            <div className="flex justify-end my-2 gap-2">
              <button
                ...
                onClick={() => setDocModalState(false)}
              >
          ...
          <div className="h-fit w-80 lg:w-fit">
            ...
            <div className="flex justify-start">
              <div className="my-2">
                ...
                <p className="py-1">
                  DBS Check Type: {dbsRequestData.typeName}
                </p>
                <p className="py-1">
                  DBS Check Cost: {`NGN ${dbsRequestData.typeCost.toFixed(2)}`}
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-end my-2 gap-2">
              <button
                className="btn text-white bg-black"
                onClick={() => setDbsModalState(false)}
              >
                <X size={18} className="mr-2" />
                Cancel
              </button>
              <button
                ...
                onClick={() => {
                  submitRequest(dbsRequestData, employee);
                }}
              >
                <div className="dots hidden" id="query-loader">
                  <div className="dot"></div>
                              ...
                              (data: UserDocumentValues, index) => (
                                <tr key={data.userDocumentId ?? index}>
                                  ...
                                  <td className="px-6 py-4 text-sm">
                                    <div className="flex items-center list-user-action">
                                      <Tippy content="Preview Dbs Check">
                                        <button className="btn btn-danger btn-icon btn-sm mr-1">
                                          <span className="btn-inner">
                                            <Trash2 />
                                          </span>
                                        </button>

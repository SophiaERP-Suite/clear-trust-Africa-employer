...
function PortalModules() {
  ...
  const handlePortalTypeChange = async (portalType: string) => {
                  ...
                  <div>
                    <div className="mt-4">
                      ...
                      <select
                        ...
                        onChange={(e) => handlePortalTypeChange(e.target.value)}
                        className="form-control text-black text-sm mt-2"
                      >
                        <option value="">Select a portal type</option>
                    ...
                    <div className="mt-4">
                      ...
                      <select
                        ...
                        disabled={!selectedPortalType || modules.length === 0}
                        className="form-control text-black text-sm mt-2"
                      >
